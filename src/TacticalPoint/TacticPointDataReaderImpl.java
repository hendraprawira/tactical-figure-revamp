...
public class TacticPointDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements TacticPointDataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private TacticPointTypeSupport typeSupport;

    public TacticPointDataReaderImpl(TacticPointTypeSupport ts)
    {
        typeSupport = ts;
    ...
    */
    ...
    {
        return new TacticPointDataReaderViewImpl(typeSupport);
    }
}
