...
public class TacticPointDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements TacticPointDataWriter
{
    ...
    public TacticPointDataWriterImpl(TacticPointTypeSupport ts)
    {
        typeSupport = ts;
