...
public class TacticPointDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements TacticPointDataReaderView
{
    ...
    public TacticPointDataReaderViewImpl(TacticPointTypeSupport ts)
    {
        typeSupport = ts;
